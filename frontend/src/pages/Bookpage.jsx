...
import { Links, useNavigate, useParams } from 'react-router';
    ...
    <div className="absolute mt-20 min-h-screen text-[#252422] bg-[#ffffff] px-4 md:px-12 pb-10">
      <p className="cursor-pointer py-3" onClick={()=> navigate("/")}>&larr; Back</p>
        <div className="flex flex-col md:flex-row">
            ...
            {user?._id===book?.user._id && <div className="text-2xl font-bold-mt-2 relative"><span onClick={() => setOpen(!open)} className="cursor-pointer tracking-widest">...</span>
            
            {open && (<div className="absolute b-[#f5f5f5] shadow-md pb-2 px-5 text-base font-normal right-0 top-10">
